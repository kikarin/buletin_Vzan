...
const contentTypes = [
  {
    ...
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <path opacity=".4" d="M14.64 7.36 4.17 17.83c-.48.48-1.28.36-1.6-.24-.37-.68-.57-1.47-.57-2.3V5.71c0-1.34.77-1.65 1.71-.71l2.58 2.59c.39.38 1.03.38 1.42 0L11.29 4c.39-.39 1.03-.39 1.42 0l1.94 1.94c.38.39.38 1.03-.01 1.42Z" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <path opacity=".4" d="M19 9.5c-2.48 0-4.5-2.02-4.5-4.5 0-.72.19-1.39.49-2H7.52C4.07 3 2 5.06 2 8.52v7.95C2 19.94 4.07 22 7.52 22h7.95c3.46 0 5.52-2.06 5.52-5.52V9.01c-.6.3-1.27.49-1.99.49Z" />
    ...
    <section id="faq" className="relative z-[1] py-24">
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('https://app.buletin.co/images/landing/use-pattern-bg.avif')",
          }}
        >
